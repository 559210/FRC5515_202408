...
public class MoveToByPath2025Cmd extends Command {
    private Swerve2025 s_Swerve;
    private MoveTo2025 m_moveToSubSys;
    private boolean isInitOk = false;
    private String m_pathName;

    public MoveToByPath2025Cmd(MoveTo2025 subSys, Swerve2025 swerve, String pathName) {
        m_pathName = pathName;
    ...
    public void initialize() {
        isInitOk = false;
        System.out.println("MoveToByPath2025Cmd init------------------> " + m_pathName);
        ...
        m_moveToSubSys.init(m_pathName);
