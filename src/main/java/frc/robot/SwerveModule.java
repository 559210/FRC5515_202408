...
public class SwerveModule {
    ...
    public SwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants, int ctreConfignum){
        ...
        if(ctreConfignum==0){
            ...
            angleEncoder.getConfigurator().apply(Robot.ctreConfigs2.swerveCANcoderConfig);
        }
        /* Angle Motor Config */
        ...
        if(ctreConfignum==0){
            ...
            mAngleMotor.getConfigurator().apply(Robot.ctreConfigs2.swerveAngleFXConfig);
        }
        resetToAbsolute();
        ...
        if(ctreConfignum==0){
            ...
            mDriveMotor.getConfigurator().apply(Robot.ctreConfigs2.swerveDriveFXConfig);
        }
