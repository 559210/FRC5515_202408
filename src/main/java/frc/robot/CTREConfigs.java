...
public final class CTREConfigs {
    ...
    public CTREConfigs(int moduletype){
        ...
        if (moduletype==0){
            ...
            swerveDriveFXConfig.MotorOutput.Inverted = Constants.Swerve.driveMotorInvert2;
            swerveAngleFXConfig.MotorOutput.Inverted = Constants.Swerve.angleMotorInvert2;
        }
